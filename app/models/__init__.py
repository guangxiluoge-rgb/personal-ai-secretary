...
class HealthAlert(Base):
    ...
    id: Mapped[int] = mapped_column(Integer, primary_key=True)
    user_id: Mapped[int] = mapped_column(ForeignKey("users.id", ondelete="CASCADE"), index=True)
    record_id: Mapped[int | None] = mapped_column(ForeignKey("health_records.id", ondelete="SET NULL"), nullable=True)
...
class Payment(Base):
    ...
    raw_event_id: Mapped[str | None] = mapped_column(String(128), nullable=True)
